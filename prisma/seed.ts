    ...
    const techniques: {
      ...
      },
      {
        ...
        childrenTechniques: [
          {
            name: "DLL Search Order Hijacking",
            ttpIdentifier: "T1178.001",
            tactic: Tactic.PERSISTENCE,
            order: 1,
          },
          {
            name: "DLL Side-Loading",
            ttpIdentifier: "T1178.002",
            tactic: Tactic.PERSISTENCE,
            order: 2,
          },
          {
            name: "Dylib Hijacking",
            ttpIdentifier: "T1178.004",
            tactic: Tactic.PERSISTENCE,
            order: 3,
          },
          {
            name: "Executable Installer File Permissions Weakness",
            ttpIdentifier: "T1178.005",
            tactic: Tactic.PERSISTENCE,
            order: 4,
          },
          {
            name: "Dynamic Linker Hijacking",
            ttpIdentifier: "T1178.006",
            tactic: Tactic.PERSISTENCE,
            order: 5,
          },
          {
            name: "Path Interception by PATH Environment Variable",
            ttpIdentifier: "T1178.007",
            tactic: Tactic.PERSISTENCE,
            order: 6,
          },
          {
            name: "Path Interception by Search Order Hijacking",
            ttpIdentifier: "T1178.008",
            tactic: Tactic.PERSISTENCE,
            order: 7,
          },
          {
            name: "Path Interception by Unquoted Path",
            ttpIdentifier: "T1178.009",
            tactic: Tactic.PERSISTENCE,
            order: 8,
          },
          {
            name: "Services File Permissions Weakness",
            ttpIdentifier: "T1178.010",
            tactic: Tactic.PERSISTENCE,
            order: 9,
          },
          {
            name: "Services Registry Permissions Weakness",
            ttpIdentifier: "T1178.011",
            tactic: Tactic.PERSISTENCE,
            order: 10,
          },
          {
            name: "COR_PROFILER",
            ttpIdentifier: "T1178.012",
            tactic: Tactic.PERSISTENCE,
            order: 11,
          },
          {
            name: "KernelCallbackTable",
            ttpIdentifier: "T1178.013",
            tactic: Tactic.PERSISTENCE,
            order: 12,
          },
          {
            name: "AppDomainManager",
            ttpIdentifier: "T1178.014",
            tactic: Tactic.PERSISTENCE,
            order: 13,
          },
        ],
